                ...
                <div class="col-lg-offset-4 col-lg-4 col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6 col-xs-12"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" type="text" name="txtemail" placeholder="Enter email id here"
                                maxlength="50" class="form-control" autofocus required />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password" type="password" name="txtpassword" placeholder="Enter password here"
