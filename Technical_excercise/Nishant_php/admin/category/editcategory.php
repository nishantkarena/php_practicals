                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Name:</strong>
                            <input type="text" name="cname" id="cname" class="form-control" placeholder="Enter Category Name" value="<?=$row['cname']?>" autofocus>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                            <select name="active" id="active" class="form-control">
                                <option value="1"<?php if($row['active']=="1"){ echo "selected";}?>>Yes</option>
                                <option value="0"<?php if($row['active']=="0"){ echo "selected";}?>>No</option>
                            </select>
                        </div>
